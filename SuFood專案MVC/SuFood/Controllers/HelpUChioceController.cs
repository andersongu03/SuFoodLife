...
namespace SuFood.Controllers
{
    public class HelpUChioceController : Controller
    {
        ...
        {
            RecurringJob.AddOrUpdate("myrecurringjob", () => SendEmails(), Cron.Daily(03, 20));
        ...
        public void SendEmails()
        {
            ...
            foreach (var check in paidOrders)
            {
                ...
                foreach (var order in orders)
                {
                    ...
                    var countShipTimes = _context.RecyleOrderDetails.Count(x => x.RecyleOrderDetailsId == recyleOrderId);
