...
namespace SuFood.Controllers
{
    public class HelpUChioceController : Controller
    {
        ...
        {           
            RecurringJob.AddOrUpdate("myrecurringjob",() => SendEmails(),Cron.Daily(03, 20)); // 每天中午 12 點執行     
        ...
        public void SendEmails()
        {
            ...
            foreach (var order in orders)
            {
                ...
                var mail = new MailMessage()
                {
                    ...
                    Subject = "感謝訂購", //主旨
                    Body = $"{o.Name}您好，您的訂單編號{o.OrdersId}，於今日{DateTime.Today}成功寄送，請期待我們隨機幫您搭配的{o.SubTotal/50}樣商品，SuFoodLife蔬服人生感謝您~",
                    IsBodyHtml = true,
