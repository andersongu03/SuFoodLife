...
namespace SuFood.Controllers
{
    public class PersonalInfoController : Controller
    {
        ...
        [HttpGet] 
        public async Task<IEnumerable<VmAccount>> GetAccount(int accountId)
        {
            var acc = _context.Account.Where(user => user.AccountId == accountId).Select(acc => new VmAccount
            {
        ...
        [HttpPost]
        public async Task<string> Edit([FromBody] VmAccount account)
        {
